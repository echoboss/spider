...
class Mm131Pipeline(object):
    def __init__(self):
        self.storge_path = os.path.join('/data','mm131')
        self.headers = {'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36',"Referer":"http://m.mm131.com/"}
    ...
    def process_item(self, item, spider):
        ...
        for nn in range(1,int(item['num']) + 1):
            fullurlname = item['img_url'] + str(nn) + '.jpg'
